define(['WebSchedulerView', 'SchedulerTableCtrl', 'q', 'vue', 'underscore-ext', 'underscore'],
  function(WebSchedulerView, SchedulerTableCtrl, q, Vue){
      ...
      fetchAppInit(scope.selectedDate).then(function(resp){
        scope.vueScope = new Vue({
          ...
          data: {
            ...
            selectedDepartmentNumber: state.selectedDepartmentNumber || resp.departments[0] && resp.departments[0].deptNumber
          },
          methods: {
