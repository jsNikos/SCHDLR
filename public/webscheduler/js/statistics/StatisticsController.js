...
function(StatisticsView, timeZoneUtils, WeekDayBarController){
	...
	function StatisticsController(args){
		...
		this.webSchedulerController = args.tableController.webSchedulerController;
		...
		this.show = function(){
			...
			findStatisticsData({requestedWeek : scope.webSchedulerController.vueScope.$data.week.startOfWeek}).then(handleResponse);
		};
